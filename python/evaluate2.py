...
class Args:
    ...
    wandb_project_name: str = "cleanRLevaluate"
    ...
    target_network_frequency: int = 30000
...
"""
    ...
    q_network.load_state_dict(torch.load(f"results/runs/{args.save_path}/experiment2.cleanrl_model"))
    # q_network = QNetwork(envs).to(device)
